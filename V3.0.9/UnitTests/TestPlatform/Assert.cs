...
namespace Microsoft.VisualStudio.TestTools.UnitTesting
{
    ...
    public sealed class Assert
    {
        ...
        public static void IsTrue(bool? condition, string message, params object[] parameters)
        {
            if (condition == false || !condition.HasValue)
            {
                HandleFail("Assert.IsTrue", message, parameters);
            }
        }
        ...
        public static void IsFalse(bool? condition, string message, params object[] parameters)
        {
            if (condition == true || !condition.HasValue)
            {
                HandleFail("Assert.IsFalse", message, parameters);
            }
        }
        ...
        public static void AreSame(object expected, object actual, string message, params object[] parameters)
        {
            if (expected != actual)
            {
                ...
                {
                    message2 = string.Format(CultureInfo.CurrentCulture, FrameworkMessages.AreSameGivenValues, new object[1] { (message == null) ? string.Empty : ReplaceNulls(message) });
                }
        ...
        //
        // Summary:
        //     Tests whether the specified decimals are equal and throws an exception if they
        //     are not equal.
        //
        // Parameters:
        //   expected:
        ...
        //
        //   actual:
        //     The second decimal to compare. This is the decimal produced by the code under
        //     test.
        //
        //   delta:
        //     The required accuracy. An exception will be thrown only if actual is different
        ...
        //
        // Summary:
        //     Tests whether the specified decimals are unequal and throws an exception if they
        //     are equal.
        //
        // Parameters:
        //   notExpected:
        //     The first decimal to compare. This is the decimal the test expects not to match
        //     actual.
        //
        //   actual:
        //     The second decimal to compare. This is the decimal produced by the code under
        ...
        //
        // Summary:
        //     Tests whether the specified longs are equal and throws an exception if they are
        //     not equal.
        //
        // Parameters:
        //   expected:
        ...
        //
        // Summary:
        //     Tests whether the specified longs are unequal and throws an exception if they
        //     are equal.
        //
        // Parameters:
        //   notExpected:
        ...
        public static void IsNotInstanceOfType(object value, Type wrongType, string message, params object[] parameters)
        {
            ...
            if (value != null)
            {
                ...
                Type type = value.GetType();
                if (wrongType.IsAssignableFrom(type))
                {
        ...
        public static void Inconclusive(string message, params object[] parameters)
        {
            ...
            throw new AssertInconclusiveException(string.Format(CultureInfo.CurrentCulture, FrameworkMessages.AssertionFailed, new object[2] { "Assert.Inconclusive", text }));
        }
        ...
        internal static void CheckParameterNotNull(object param, string assertionName, string parameterName, string message, params object[] parameters)
        {
            if (param == null)
            {
                HandleFail(assertionName, string.Format(CultureInfo.CurrentCulture, FrameworkMessages.NullParameterToAssert, new object[2] { parameterName, message }), parameters);
            }
        }
        ...
        internal static string ReplaceNulls(object input)
        {
            ...
            if (text == null)
            {
                return FrameworkMessages.NullObjectInString;
            }
